...
data = pd.read_csv(r'https://raw.githubusercontent.com/izqdiario-datos/mapa_amba/main/distribucion_establecimientos_productivos_descripciones_AMBA_filtro.csv')
